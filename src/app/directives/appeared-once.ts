// taken from https://stackoverflow.com/questions/43573489/angular-4-how-to-trigger-an-animation-when-a-div-comes-into-the-viewport
import {
...
export class AppearDirective implements AfterViewInit, OnDestroy {
  ...
  isVisible() {
    return this.scrollPos >= this.elementPos || (this.scrollPos + this.windowHeight) >= (this.elementPos + this.elementHeight / 3);
  }
